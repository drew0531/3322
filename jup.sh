...
dir_root=$dir_shell
url_shell=${JD_SHELL_URL:-https://ghproxy.com/https://github.com/dewe0531/3322.git}
url_scripts=${JD_SCRIPTS_URL:-https://ghproxy.com/https://github.com/panghu999/jd_scripts.git}
